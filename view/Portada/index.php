...
<head>
    ...
    <title>Administrador - Portada</title>
</head>
...
<body>
    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <span class="breadcrumb-item active">Portada</span>
            </nav>
        </div><!-- br-pageheader -->
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">Lista de Imagenes</h4>
            <p class="mg-b-0">En este modulo se muestran la lista de imagenes</p>
        </div>
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="row justify-content-end">
                            ...
                            <div class="col-12 col-sm-5">
                                <button id="btnnuevo" class="btn btn-outline-primary btn-block mg-b-10">Nueva Imagen</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    ?>
    <script src="./portada.js" type="text/javascript"></script>
