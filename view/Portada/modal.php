            ...
            <form method="post" id="empresa_form">
                ...
                <div class="modal-body pd-20">
                    ...
                    <div class="form-layout form-layout-1">
                        <div class="row ">
                            <div class="col-lg-12">
                                <p class="font-weight-bold" style="background-color: yellow;">Recuerde que las imagenes deben tener las siguientes dimensiones : 1100 * 327px</p>
                               
                            </div><!-- col-4 -->
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">Portada: <span class="tx-danger">*</span></label>
