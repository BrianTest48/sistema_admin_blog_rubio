...
<body>
    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <span class="breadcrumb-item active">Boletin</span>
            </nav>
        </div><!-- br-pageheader -->
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">Lista de Correos registrados</h4>
            <p class="mg-b-0">En este modulo se podra visualizar los correos registrados en el blog.</p>
        </div>
    ...
    ?>
    <script src="./boletin.js" type="text/javascript"></script>
