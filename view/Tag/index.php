...
<body>
    ...
    <div class="br-mainpanel">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">Tags</h4>
            <p class="mg-b-0">En este modulo se podra realizar el mantenimiento de los tags.</p>
        </div>
        <div class="br-pagebody">
            ...
            <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="row justify-content-end">
                            ...
                            <div class="col-12 col-sm-5">
                                <button id="btnnuevo" class="btn btn-outline-primary btn-block mg-b-10">Nuevo Tag</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-wrapper">
                    <table id="tag_data" class="table display responsive nowrap" style="width: 100%">
                        <thead>
                            <tr>
